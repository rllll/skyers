...
import com.xuexiang.skyers.core.SimpleListAdapter;
...
public class Tab3Fragment extends BaseFragment {
    ...
    @BindView(R.id.refreshStories)
    SmartRefreshLayout mRefreshLayout;
    @BindView(R.id.recyclerViewOfStory)
    ...
    protected void initViews() {
        ...
        mRecyclerView.setAdapter(mAdapter = new Tab3Adapter());
    ...
    protected void initListeners() {
        ...
        mRefreshLayout.setOnLoadMoreListener(refreshLayout -> refreshLayout.getLayout().postDelayed(() -> {
            mAdapter.loadMore(DataProvider.getStory());
        ...
        DisposablePool.get().add(RxJavaUtils.polling(0, 50, TimeUnit.MILLISECONDS)
                .subscribe(aLong -> {
                    if (progress <= 100) {
                        ...
                        mAdapter.refresh(DataProvider.getStory());
